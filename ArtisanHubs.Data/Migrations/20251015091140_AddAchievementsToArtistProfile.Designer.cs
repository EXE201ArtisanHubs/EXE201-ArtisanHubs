...
namespace ArtisanHubs.Data.Migrations
{
    ...
    [Migration("20251015091140_AddAchievementsToArtistProfile")]
    partial class AddAchievementsToArtistProfile
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ArtisanHubs.Data.Entities.Achievement", b =>
                {
            ...
            modelBuilder.Entity("ArtisanHubs.Data.Entities.Cart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ArtisanHubs.Data.Entities.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ArtisanHubs.Data.Entities.ForumPost", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ArtisanHubs.Data.Entities.ForumThread", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ArtisanHubs.Data.Entities.ForumTopic", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ArtisanHubs.Data.Entities.Cart", b =>
                {
                    b.HasOne("ArtisanHubs.Data.Entities.Account", "Account")
                        .WithOne()
                        .HasForeignKey("ArtisanHubs.Data.Entities.Cart", "AccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ArtisanHubs.Data.Entities.CartItem", b =>
                {
                    b.HasOne("ArtisanHubs.Data.Entities.Cart", "Cart")
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("ArtisanHubs.Data.Entities.ForumPost", b =>
                {
                    b.HasOne("ArtisanHubs.Data.Entities.Account", "Author")
                        .WithMany()
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ArtisanHubs.Data.Entities.ForumThread", "ForumThread")
                        .WithMany("Posts")
            ...
            modelBuilder.Entity("ArtisanHubs.Data.Entities.ForumThread", b =>
                {
                    ...
                    b.HasOne("ArtisanHubs.Data.Entities.ForumTopic", "ForumTopic")
                        .WithMany("Threads")
